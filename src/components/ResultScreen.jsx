    ...
    <main className="mx-auto flex min-h-screen w-full max-w-6xl flex-col justify-center px-4 py-6 sm:px-6">
      <section className="rounded-lg bg-white p-5 shadow-soft sm:p-8">
        <div className="grid gap-6 lg:grid-cols-[0.8fr_1.2fr]">
          <div className="rounded-lg bg-navy-900 p-5 text-white sm:p-6">
            <p className="text-sm font-semibold uppercase tracking-[0.22em] text-amber-200">
              Final Result
            </p>
            <h1 className="mt-4 text-5xl font-bold tracking-normal">
              {score.percentage}%
            </h1>
            <p className="mt-2 text-sm text-slate-200">
              {score.earned} of {score.totalPossible} points
            </p>

            <div className="mt-6 border-t border-white/10 pt-5">
              <p className="text-sm font-semibold text-slate-300">Player</p>
